...
public class SaveSketchLogic : MonoBehaviour
{
    ...
    public void SaveSketch()
    {
        ...
        else
        {
            ...
            string filename = PlayerManager.model_id.Replace(Path.DirectorySeparatorChar + "", "_") + "_" + sketch_type + "_" + PlayerManager.player_id;
            Debug.Log(filename + "  " + "文件名1");
