...
public class PlayerManager : MonoBehaviour
{
    ...
    //public static string model_dir = @"C:\3D\dww\Sketch_VR\Assets\path\demo_dataset";
    //public static string save_dir = @"C:\3D\dww\Sketch_VR\Assets\path\demo_savedir";
    //public static string namelist_path = @"C:\3D\dww\Sketch_VR\Assets\path\demo_namelist.txt";
    public static string model_dir = @".\path\demo_dataset";
    public static string save_dir = @".\path\demo_savedir";
    public static string namelist_path = @".\path\demo_namelist.txt";
